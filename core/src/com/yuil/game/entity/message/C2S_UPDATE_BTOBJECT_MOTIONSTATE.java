...
public class C2S_UPDATE_BTOBJECT_MOTIONSTATE implements Message {
	public final int type=EntityMessageType.C2S_UPDATE_BTOBJECT_MOTIONSTATE.ordinal();
	long id=0;
		
	
	public C2S_UPDATE_BTOBJECT_MOTIONSTATE() {
		super();
		// TODO Auto-generated constructor stub
	}
	
	public C2S_UPDATE_BTOBJECT_MOTIONSTATE(ByteBuf src) {
		super();
		this.set(src);
		// TODO Auto-generated constructor stub
	}
	...
	public String toString() {
		return "C2S_UPDATE_BTOBJECT_MOTIONSTATE [type=" + type + ", id=" + id +"]";
	}
