...
public class C2S_ADD_PLAYER implements Message {
	public final int type=EntityMessageType.C2S_ADD_PLAYER.ordinal();
	long id=0;
	
	
	public C2S_ADD_PLAYER() {
		super();
		// TODO Auto-generated constructor stub
	}
	
	public C2S_ADD_PLAYER(ByteBuf src) {
		super();
		this.set(src);
		// TODO Auto-generated constructor stub
	}
