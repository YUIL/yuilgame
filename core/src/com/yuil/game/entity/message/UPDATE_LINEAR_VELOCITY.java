...
public class UPDATE_LINEAR_VELOCITY implements Message {
	public final int type=EntityMessageType.UPDATE_LINEAR_VELOCITY.ordinal();
	long id;
	float x;
	float y;
	float z;
	...
	public UPDATE_LINEAR_VELOCITY() {
		super();
		// TODO Auto-generated constructor stub
	}
	
	public UPDATE_LINEAR_VELOCITY(ByteBuf src) {
		super();
		this.set(src);
		// TODO Auto-generated constructor stub
	}
